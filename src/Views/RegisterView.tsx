                ...
                <div className="bg-white py-6 w-1/4 border border-black rounded-lg">
                    <div className='w-full'>
                        ...
                        <form onSubmit={handleOnSubmit} className="flex flex-col">
                            ...
                            <div className="my-3 flex justify-center">
                                <input type="password" onChange={(e)=>{setConfPassword(e.target.value)}} placeholder="Confirm Password" className="py-2 px-2 w-1/2 border border-gray-300 rounded-lg" />
                            </div>
                            <div className="my-3 flex justify-center">
                                <label htmlFor="" className='mr-2'>Role :</label>
                                <select name="roles" id="roles" onChange={(e)=>{
                            ...
                            <div className="mt-2 text-center">
                                ...
                                <Link to={`/`} className='text-xs'>Already have account ? Login Here !</Link>
                            </div>
                        </form>
                    </div>
                </div>
